...
\urlstyle{same}
\hypersetup{
  pdftitle={Modelagem Fuzzy-PLS da Dinâmica de Fósforo e Nitrogênio em Usos do Solo no Sul do Tocantins},
...
\title{Modelagem Fuzzy-PLS da Dinâmica de Fósforo e Nitrogênio em Usos
do Solo no Sul do Tocantins}
\author{Diego et al.}
\date{2025-10-31}
\begin{document}
\maketitle
...
{\centering \includegraphics[width=0.7\linewidth,height=\textheight,keepaspectratio]{chapters/../figures/mapa_area.png}
...
\bottomrule\noalign{}
\endlastfoot
\includegraphics[width=0.35\linewidth,height=\textheight,keepaspectratio]{chapters/../figures/cerrado.jpg}
&
\includegraphics[width=0.35\linewidth,height=\textheight,keepaspectratio]{chapters/../figures/eucalipto.jpg}
&
\includegraphics[width=0.35\linewidth,height=\textheight,keepaspectratio]{chapters/../figures/mogno.jpg} \\
(d) & (e) & \\
\includegraphics[width=0.35\linewidth,height=\textheight,keepaspectratio]{chapters/../figures/teca.jpg}
&
\includegraphics[width=0.35\linewidth,height=\textheight,keepaspectratio]{chapters/../figures/agricultura.jpg}
& \\
\end{longtable}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{chapters/../figures/trincheira.png}}
...
específica de ortofosfato (H2PO4?) em superfícies de ácidos húmicos via
...
\includegraphics[width=0.9\linewidth,height=\textheight,keepaspectratio]{chapters/../figures/biplot_plsr_pt.png}
...
mensuração revelou cargas fatoriais elevadas (? = 0.981 a 0.990) para
...
\includegraphics[width=0.95\linewidth,height=\textheight,keepaspectratio]{chapters/../figures/analise_caminhos_pls.png}
...
A consistência interna elevada (a \textgreater{} 0.97) e a variância
...
oriundos das frações húmicas (ß = 1.286 para N\_húmico ? N\_total e
...
Confiabilidade (a) & \textgreater{} 0.97 & Consistência interna
\textgreater{} 0.97 \\
Comunalidade (AVE) & \textgreater{} 0.95 & Variância média bem
explicada \\
\end{longtable}

Os coeficientes negativos associados às frações lábeis (ß = -0.313 para
...
As cargas fatoriais elevadas (? = 0.981-0.990 para todos os indicadores)
...
A relação positiva dominante das frações húmicas (ß = 1.286) corrobora a
...
terços finais do modelo. A magnitude de ß = 1.286 indica que incrementos
...
A relação negativa das frações lábeis (ß = -0.313), embora aparentemente
...
ß(húmico) = +1.286 e ß(lábil) = -0.313 mantém proporcionalidade
...
um ß negativo), sistemas com elevada humificação não apresentariam
...
sistemas naturais (ß = 1.286), configurando a referência biogeoquímica
...
ß(húmico) = 1.180, 8.2\% inferior ao Cerrado. A redução indica
...
{\centering \includegraphics[width=0.95\linewidth,height=\textheight,keepaspectratio]{chapters/../figures/comparacao_coeficientes.png}
...
o Mogno-africano (ß = 1.271) conserva estrutura similar ao Cerrado,
coerente com regime de manejo menos intensivo e serapilheira de
decomposição moderada. O Eucalipto (ß = 1.275) supera ligeiramente o
...
(ß = 1.372), indicando humificação intensificada. Embora à primeira
...
Para o intervalo de variação de ß(húmico) de 1.180 (Agricultura) a 1.372
...
ótimos. Tal amplitude traduz-se em recomendações práticas: (i) manter ß
...
{\centering \includegraphics[width=0.9\linewidth,height=\textheight,keepaspectratio]{chapters/../figures/funcoes_pertinencia_entrada.png}
...
{\centering \includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio]{chapters/../figures/funcao_pertinencia_saida.png}
...
{\centering \includegraphics[width=0.9\linewidth,height=\textheight,keepaspectratio]{chapters/../figures/boxplot_fsnsi_uso_terra.png}
...
estatisticamente significativa (? = 1.64, IC 95\%: 0.07-3.22, p =
...
sistemas agrícolas altera profundamente a dinâmica de emissão de CO2 e
...
{\centering \includegraphics[width=0.95\linewidth,height=\textheight,keepaspectratio]{chapters/../figures/fsnsi_profundidade_uso_terra.png}
...
50 µm), limitando a difusão de O2 para horizontes subsuperficiais e
criando condições de hipoxia que favorecem processos anaeróbicos de
desnitrificação (N2O, N2) e redução de formas oxidadas de P ligadas a
...
devido à limitação de O2, comprometendo processos-chave como a
...
estabilização de N que se alinham com os coeficientes estruturais ß
...
\textless{} 1.2 g cm?³), enquanto a emissão de N2O aumenta em 2-3 vezes
...
qual frações finas do solo (argila \textless{} 2 µm, silte 2-50 µm)
...
NTAH, NTHum, PTAH e PTHum (ß = 1.286 para N\_húmico ? N\_total), em
...
coeficientes de caminho (ß = 1.286 para N\_húmico ? N\_total, ß = -0.313
